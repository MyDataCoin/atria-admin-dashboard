...
export default function Sidebar({ 
  ...
  const menuItems = [
    ...
    { id: 'analytics', label: 'Аналитика & Биржи', icon: LineChart },
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-sm">
            ...
            <div className="bg-white/5 border border-white/10 rounded-sm p-3.5 text-left">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[9px] font-mono font-bold uppercase text-[#A38D6D] tracking-wider mt-0.5 truncate">
                    {adminUser.role}
                  </p>
                </div>
              </div>
